...
class _Strategy:
    ...
    strategy_groups = {
        ...
        "allconditionalcooperators + Q-Learning": ["IV_NNN", "V_NNN", "VI_NNN", "VII_NNN", "XII_NNN"],
        "notbadcooperators + Q-Learning": ["IV_NNN", "VI_NNN", "XII_NNN"],
        "goodcooperators + Q-Learning": ["V_NNN", "VII_NNN", "XII_NNN"],
        "cooperatorsdefect + Q-Learning": ["IV_NNN", "V_NNN"] + ["XII_NNN"],
